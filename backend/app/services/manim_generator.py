"""
Manim video generation service - adapted from readme-ai approach
"""
import asyncio
import subprocess
import os
...
""" + code
    ...
    def create_sample_manim_code(self, concept: str, explanation: str) -> str:
        """
        Create sample Manim code for a mathematical concept
        ...
        Returns:
            Manim code string
        """
        # This is a simple template - in production, this would be generated by AI
        template = f'''
class {concept.replace(" ", "")}Scene(Scene):
    def construct(self):
        ...
        # Explanation text
        explanation = Text("{explanation[:100]}...", font_size=24)
